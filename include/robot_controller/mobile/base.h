        ...
        */
        class MobileBase
        {
            public:
                 ...
                 * @param robot_data (std::shared_ptr<RobotData::Mobile::MobileBase>)
            ...
            protected:
                ...
                std::shared_ptr<RobotData::Mobile::MobileBase> robot_data_;  // Pointer to mobile robot data.
                RobotData::Mobile::KinematicParam param_;                    // Cached kinematic parameters of the robot.
