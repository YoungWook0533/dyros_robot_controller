...
namespace RobotData
{
    ...
    {
        class MobileManipulatorBase : public Manipulator::ManipulatorBase, public Mobile::MobileBase
        {
            public:
                MobileManipulatorBase(const Mobile::KinematicParam& mobile_param,
                ...
                using Manipulator::ManipulatorBase::computeMassMatrix; 
                using Manipulator::ManipulatorBase::computeGravity; 
                using Manipulator::ManipulatorBase::computeCoriolis; 
                using Manipulator::ManipulatorBase::computeNonlinearEffects; 
                ...
                using Manipulator::ManipulatorBase::computePose;
                using Manipulator::ManipulatorBase::computeJacobian;
                using Manipulator::ManipulatorBase::computeJacobianTimeVariation;
                using Manipulator::ManipulatorBase::computeVelocity;
                using Manipulator::ManipulatorBase::computeMinDistance;
                ...
                using Manipulator::ManipulatorBase::computeManipulability;
                ...
                // Manipulator taskspace
                using Manipulator::ManipulatorBase::getManipulability;
                ...
                virtual VectorXd getMobileBaseVel() const {return MobileBase::getBaseVel();}
        

            protected:
                using Manipulator::ManipulatorBase::updateKinematics;
                using Manipulator::ManipulatorBase::updateDynamics;
