...
from dyros_robot_controller.manipulator.robot_data import RobotData
from dyros_robot_controller.manipulator.robot_controller import RobotController
...
class FR3Controller:
    def __init__(self, dt: float):
        ...
        urdf_file_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "robots", "fr3", "fr3.urdf")
        srdf_file_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "robots", "fr3", "fr3.srdf")
