...
class Ros2QtGui(Node, QWidget):
    def __init__(self):
        ...
        self.setWindowTitle('PCV FR3 Controller GUI')

        # Publishers & Subscribers
        self.mode_pub = self.create_publisher(Int32, 'pcv_fr3_controller/mode_input', 10)
        self.pose_pub = self.create_publisher(PoseStamped, 'pcv_fr3_controller/target_pose', 10)
        self.joint_sub = self.create_subscription(JointState, '/joint_states', self.joint_state_callback, 10)
        self.ee_sub = self.create_subscription(PoseStamped, 'pcv_fr3_controller/ee_pose', self.ee_pose_callback, 10)
