...
from dyros_robot_controller.robot_data import MobileManipulatorBase as DataMomaBase


class MobileManipulatorControllerBase(drc.MobileManipulatorControllerBase):
    def __init__(self, dt: float, robot_data: DataMomaBase):
        if not isinstance(robot_data, DataMomaBase):
