...
namespace HuskyFR3Controller
{
    ...
    : ControllerInterface(node, dt, std::move(jd))
    {
        ...
        robot_ = std::make_shared<HuskyFR3RobotData>(urdf_path, srdf_path, true);
        ...
        ee_pose_pub_ = node_->create_publisher<geometry_msgs::msg::PoseStamped>("husky_fr3_controller/ee_pose", 10);
