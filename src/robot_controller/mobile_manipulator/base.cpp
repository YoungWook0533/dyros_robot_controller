...
namespace RobotController
{
    ...
    {
        MobileManipulatorBase::MobileManipulatorBase(const double& dt,
        ...
        : robot_data_(robot_data)
        {
            ...
            QP_moma_IK_ = std::make_unique<QP::MobileManipulatorIK>(robot_data_);
            QP_moma_ID_ = std::make_unique<QP::MobileManipulatorID>(robot_data_);
        }

        void MobileManipulatorBase::setManipulatorJointGain(const VectorXd& Kp, const VectorXd& Kv)
        {
        ...
        void MobileManipulatorBase::setTaskGain(const VectorXd& Kp, const VectorXd& Kv)
        {
        ...
        VectorXd MobileManipulatorBase::moveManipulatorJointPositionCubic(const VectorXd& q_mani_target,
        ...
        VectorXd MobileManipulatorBase::moveManipulatorJointTorqueStep(const VectorXd& qddot_mani_target)
        {
        ...
        VectorXd MobileManipulatorBase::moveManipulatorJointTorqueStep(const VectorXd& q_mani_target,
                                                                       const VectorXd& qdot_mani_target)
        {
        ...
        VectorXd MobileManipulatorBase::moveManipulatorJointTorqueCubic(const VectorXd& q_mani_target,
                                                                        const VectorXd& qdot_mani_target,
                                                                        const VectorXd& q_mani_init,
                                                                        const VectorXd& qdot_mani_init,
                                                                        const double& current_time,
        ...
        void MobileManipulatorBase::QPIKStep(const Affine3d& x_target, 
        ...
        void MobileManipulatorBase::QPID(const VectorXd& xddot_target,
                                         const std::string& link_name,
        ...
        void MobileManipulatorBase::QPIDStep(const Affine3d& x_target, 
                                           const VectorXd& xdot_target,
                                           const std::string& link_name,
                                           VectorXd& opt_qddot_mobile,
                                           VectorXd& opt_torque_manipulator)
        ...
        void MobileManipulatorBase::QPIDCubic(const Affine3d& x_target,
                                            const VectorXd& xdot_target,
                                            const Affine3d& x_init,
                                            const VectorXd& xdot_init,
                                            const double& current_time,
