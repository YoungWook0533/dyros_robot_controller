...
namespace RobotData
{
    namespace Manipulator
    {
                                         ...
                                         const bool verbose)
        {
            ...
            if (!srdf_file.good()) std::cout << "\033[1;31m" << "SRDF file does not exist! : " << "\033[0m" << srdf_path << "\033[0m" << std::endl;
        ...
        bool ManipulatorBase::updateKinematics(const VectorXd& q, const VectorXd& qdot)
        {
        ...
        bool ManipulatorBase::updateDynamics(const VectorXd& q, const VectorXd& qdot)
        {
        ...
        // ================================ Compute Functions ================================
        // Joint space  
        MatrixXd ManipulatorBase::computeMassMatrix(const VectorXd& q)
        {      
        ...
        VectorXd ManipulatorBase::computeGravity(const VectorXd& q)
        {      
            pinocchio::Data data = pinocchio::Data(model_);
        ...
        VectorXd ManipulatorBase::computeCoriolis(const VectorXd& q, const VectorXd& qdot)
        { 
            pinocchio::Data data = pinocchio::Data(model_);
        ...
        VectorXd ManipulatorBase::computeNonlinearEffects(const VectorXd& q, const VectorXd& qdot)
        {
            pinocchio::Data data = pinocchio::Data(model_);
        ...
        // Task space
        Affine3d ManipulatorBase::computePose(const VectorXd& q, const std::string& link_name)
        {
        ...
        MatrixXd ManipulatorBase::computeJacobian(const VectorXd& q, const std::string& link_name)
        {
            pinocchio::FrameIndex link_index = model_.getFrameId(link_name);
            if (link_index == static_cast<pinocchio::FrameIndex>(-1))  
            {
        ...
        MatrixXd ManipulatorBase::computeJacobianTimeVariation(const VectorXd& q, const VectorXd& qdot, const std::string& link_name)
        {
            pinocchio::FrameIndex link_index = model_.getFrameId(link_name);
            if (link_index == static_cast<pinocchio::FrameIndex>(-1))  
            {
        ...
        VectorXd ManipulatorBase::computeVelocity(const VectorXd& q, const VectorXd& qdot, const std::string& link_name)
        {
        ...
        MinDistResult ManipulatorBase::computeMinDistance(const VectorXd& q, const VectorXd& qdot, const bool& with_grad, const bool& with_graddot, const bool verbose)
        {
        ...
        ManipulabilityResult ManipulatorBase::computeManipulability(const VectorXd& q, const VectorXd& qdot, const bool& with_grad, const bool& with_graddot, const std::string& link_name)
        {
        ...
        // ================================ Get Functions ================================
        // Task space  
        Affine3d ManipulatorBase::getPose(const std::string& link_name) const
        {
            pinocchio::FrameIndex link_index = model_.getFrameId(link_name);
            if (link_index == static_cast<pinocchio::FrameIndex>(-1))  
            {
        ...
        MatrixXd ManipulatorBase::getJacobian(const std::string& link_name)
        {
            pinocchio::FrameIndex link_index = model_.getFrameId(link_name);
            if (link_index == static_cast<pinocchio::FrameIndex>(-1))  
            {
        ...
        MatrixXd ManipulatorBase::getJacobianTimeVariation(const std::string& link_name)
        {
            pinocchio::FrameIndex link_index = model_.getFrameId(link_name);
            if (link_index == static_cast<pinocchio::FrameIndex>(-1))  
            {
        ...
        VectorXd ManipulatorBase::getVelocity(const std::string& link_name)
        {
            return getJacobian(link_name) * qdot_;
        }

        MinDistResult ManipulatorBase::getMinDistance(const bool& with_grad, const bool& with_graddot, const bool verbose)
        {
            MinDistResult result;
        ...
        ManipulabilityResult ManipulatorBase::getManipulability(const bool& with_grad, const bool& with_graddot, const std::string& link_name)
        {
            ManipulabilityResult result;
            result.setZero(dof_);
